...
let domain = 'https://demoapi.dtcms.net'
// 
  ...
  let resObj = {
    status: successState, message: [{
      ...
      // img: 'http://www.liulongbin.top:3005/images/lunbo2-min.jpg'
		img: 'https://t8.baidu.com/it/u=3515831028,3572013397&fm=85&app=131&size=f242,150&n=0&f=PNG?s=C6507C87CCA42C8034B249660300F073&sec=1657558800&t=6751197f819f72f9ca0c7c35f4fb74c6'
    }, {
		id: 3,
      url: 'https://baike.baidu.com/item/PHP/9337?fr=aladdin',
      // img: 'http://www.liulongbin.top:3005/images/lunbo3-min.jpg'
		img: 'https://t7.baidu.com/it/u=1828435019,3371441909&fm=74&app=80&size=f256,256&n=0&f=PNG?sec=1657558800&t=c07db3f133f57f56ba04e3b2f1c225de'
    },
    {
      id: 4,
      url: 'https://baike.baidu.com/item/Java/85979?fr=aladdin',
        // img: 'http://www.liulongbin.top:3005/images/lunbo3-min.jpg'
      img: 'https://t9.baidu.com/it/u=3031107601,704799942&fm=74&app=80&size=f256,256&n=0&f=JPEG&fmt=auto?sec=1657558800&t=ad46248b3947a1ee651c70342b12f905'
    }
  ]
  }
  ...
  req.db.driver.execQuery(sql, (err, data) => {
    ...
    if (err) {
      ...
      return
		...
		// http://vue.studyit.io
	  data.forEach(item => item.thumb_path = 'https://demoapi.dtcms.net' + item.thumb_path)
  ...
  req.db.driver.execQuery(sql, (err, datas) => {
    ...
    if (err) {
	  ...
	  datas.forEach(item => {
		// http://ofv795nmp.bkt.clouddn.com/
		// http://vue.studyit.io
		item.img_url = 'https://demoapi.dtcms.net' + item.img_url
	  })
...
exports.getimage = (req, res) => {
  ...
  req.db.driver.execQuery(sql, (err, data) => {
	...
	data.forEach(item => {
		// http://ofv795nmp.bkt.clouddn.com/
		// http://vue.studyit.io
		item.src = 'https://demoapi.dtcms.net' + item.src
	})
